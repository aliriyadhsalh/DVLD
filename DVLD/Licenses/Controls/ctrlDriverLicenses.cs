...
namespace DVLD.Licenses.Local_Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            if(_Driver == null)
            {
                MessageBox.Show("There is no deiver with this driver ID =" + _DriverID," Not Found",MessageBoxButtons.OK,MessageBoxIcon.Error);
                return;
            }
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("There is no deiver with this person ID =" + _DriverID, " Not Found", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
