...
namespace DVLD_Buisness
{
...

    {
        ...
        public  bool IsThereAnActiveScheduledTest( clsTestType.enTestType TestTypeID)  => clsLocalDrivingLicenseApplicationData.IsThereAnActiveScheduledTest(this.LocalDrivingLicenseApplicationID, (int)TestTypeID);

        public clsTest GetLastTestPerTestType(clsTestType.enTestType TestTypeID) => clsTest.FindLastTestPerPersonAndLicenseClass(this.ApplicantPersonID, this.LicenseClassID, TestTypeID);
        public byte GetPassedTestCount() => clsTest.GetPassedTestCount(this.LocalDrivingLicenseApplicationID);

        public static byte GetPassedTestCount(int LocalDrivingLicenseApplicationID) => clsTest.GetPassedTestCount(LocalDrivingLicenseApplicationID);
        ...
        public int GetActiveLicenseID()=> clsLicense.GetActiveLicenseIDByPersonID(this.ApplicantPersonID, this.LicenseClassID);
    }
}
